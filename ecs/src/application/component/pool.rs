...
pub trait AnyComponentPool {
    ...
    */
    ...
    fn try_remove_get(&mut self, entity: &Entity) -> Option<Box<dyn AnyComponent>>;
    fn try_remove(&mut self, entity: &Entity);
}
...
impl<T: AnyComponent + 'static> ComponentPool<T> {
    ...
    */
    ...
    pub fn try_get(&mut self, entity: &Entity) -> Option<&mut T> {
